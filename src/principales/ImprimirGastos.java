...
public class ImprimirGastos {
	...
	public static void imprimirInforme(Proyecto proyecto) {
		...
		System.out
				.println("Fecha Inicio : " + proyecto.getFechaInicio() + " Fecha Fin real : " + proyecto.getFechaFinReal());
		...
		for (ProyectoConEmpleados pce : asignados) {
			if (pce.getProyecto().getIdProyecto().equals(proyecto.getIdProyecto())) {
				System.out
						.println("Apellidos, nombre : " + pce.getEmpleado().getApellidos() + ", " + pce.getEmpleado().getNombre() +
		...
		System.out.println(
				"Total Gastado : " + (epdao.costeActualDeEmpleadosEnProyecto(proyecto.getIdProyecto()) + totalImportes));
